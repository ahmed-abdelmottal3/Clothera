...
import { useVerifyResetCode } from '@/hooks/auth';
import { Input } from '@/components/ui/Input';
import { Button } from '@/components/ui/Button';
import Image from 'next/image';

export default function VerifyCodePage() {
  const { register, handleSubmit, errors, isLoading } = useVerifyResetCode();
        ...
        <div className="w-full max-w-[440px] animate-slide-left">
          ...
          >
            ...
            <p className="text-text-secondary mb-6">
              Enter the code sent to your email address to verify your identity.
            </p>
      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-12 relative overflow-hidden ">
        ...
        <div className="z-10 text-center animate-slide-right">
          ...
          <p className="text-lg text-accent max-w-[400px] leading-relaxed">
            Please verify your identity to proceed with resetting your password.
          </p>
